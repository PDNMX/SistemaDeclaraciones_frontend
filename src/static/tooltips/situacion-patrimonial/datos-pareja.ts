const tooltipData = {
  ...
  actividadLaboral:
    'Indicar si el cónyuge, concubina/concubinario o sociedad de convivencia, se encuentra trabajando actualmente, seleccionando alguno de los siguientes campos: privado, público, otro (especificar) o ninguno.',
  sectorPublico: {
    nivelOrdenGobierno:
  ...
  sectorPrivado: {
    ...
    salarioMensualNeto: 'Deberá especificar el monto mensual neto, sin centavos, que percibe el cónyuge o Pareja.',
    proveedorContratistaGobierno: 'Señalar sí o no, la Pareja vende o presta algún servicio al gobierno.',
  },
