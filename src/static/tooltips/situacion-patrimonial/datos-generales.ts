const tooltipData = {
  ...
  correoPersonal:
    'Escribir la dirección de correo electrónico que el Declarante haya generado para uso personal. En caso de no contar con él, deberá generar una cuenta.',
  telefonoCasa: 'Escribir el número telefónico de su domicilio, incluir lada.',
  telefonoCelular: 'Escribir los diez dígitos de su número celular.',
  estadoCivil:
    'Es la condición del Declarante en función de si tiene o no Pareja, según sus circunstancias o situación legal respecto a ello.',
  regimenMatrimonial: 'En su caso, especificar: sociedad conyugal, separación de bienes u otro/especifique.',
  paisNacimiento: 'De la lista desplegable, el Declarante deberá elegir el país donde nació.',
  nacionalidad: 'De la lista desplegable, el Declarante deberá elegir su nacionalidad.',
};
